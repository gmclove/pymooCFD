...
from pymooCFD.setupOpt import procOptDir, client, studyDir, meshSF, baseCaseMS
...
from pymooCFD.util.gridInterp import GridInterp2D
...
def runCornerCases(xl, xu):  # alg):
    ...
    ccDir = os.path.join(procOptDir, 'runCC')
    makeDir(ccDir)

    from pymooCFD.setupCFD import runPop
    runPop(ccDir, 'cc', lim_perms, 'slurm')
