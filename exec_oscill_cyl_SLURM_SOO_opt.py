from pymooCFD.studies.oscill_cyl_soo_SLURM import exec_test, exec_study, BaseCase, \
                                            MinimizeCFD
...
def main():
    ...
    opt_run.problem.BaseCase.nTasks = 10
    # print('POST-PROCESS')
    # opt_run.test_case._postProc()
    # opt_run.bnd_cases[0].mesh_study.run()
