...
This platform provides an interface between the multi-objective optimization library, pymoo, and computational fluid dynamic (CFD) modeling software. The aim of this project is to provide users with minimal background in coding the ability to conduct optimization studies on CFD models in  a timely manner.
