...
#
# pt = np.array([0.00004782, 1, 0.00000000001])
# print(str(pt))
# with np.printoptions(precision=20, suppress=True, floatmode='fixed'): #, formatter={'all': lambda x: '%.20f' % x}):
#     print(pt)
#     caseName = str(pt).replace(
#         '[', '').replace(']', '').replace(' ', '_')
# print(caseName)
#
# vars = np.fromstring(caseName, sep='_')
# print(vars)
