...
__name__ = "pymooCFD"
__author__ = "George Love"
__url__ = "https://github.com/gmclove/pymooCFD"
...
data = dict(
    ...
    description="CFD Interface for pymoo: Multi-Objective Optimization in Python",
...
#
# def packages():
#     return ["pymooCFD"] + ["pymooCFD." + e for e in setuptools.find_packages(where='pymooCFD')]
