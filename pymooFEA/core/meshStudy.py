...
# from pymooFEA.core.fea_case import FEACase
from pymooFEA import config
import logging
import os
import copy
import numpy as np
...
from pymooFEA.util.loggingTools import MultiLineFormatter
from pymooFEA.util.handleData import saveTxt


class MeshStudy:  # (FEACase):
    ...
    def getLogger(self):
        ...
        logger.setLevel(config.FEA_CASE_LOGGER_LEVEL)
        # Filters
