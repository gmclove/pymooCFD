...
from pymooFEA.util.sysTools import copy_and_overwrite
...
class FEACaseDB(PyClassDB):
    def __init__(self, FEACase, location, precision=30, collect_all_data=True):
        super().__init__(FEACase, location)
