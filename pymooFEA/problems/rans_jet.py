...
# from pymooFEA.core.parallelProc import ParellelProc
...
import gmsh
import math
from pymooFEA.core.feaCase import FluentCase
from pymooFEA.util.handleData import saveTxt
import matplotlib.pyplot as plt
import os
import numpy as np
import h5py

from pymooFEA.util.gridInterp import GridInterp2D, GridInterp3D, radialAvg
...
class RANSJet(FluentCase):
    ...
    hqSim_dir = os.path.join(os.path.dirname(__file__), 'rans_jet_data')
...
class RANSJet_x3(RANSJet):
    ...
    def _preProc(self):
        ...
        lines = [
            ...
            # inlet
            '/define/boundary-conditions/modify-zones/zone-type inlet velocity-inlet',
            f'/define/boundary-conditions velocity-inlet inlet n n y y n {outVel} n 0 n 300 n n y 5 10 n n {self.x[2]}',
            # axis
            '/define/boundary-conditions/modify-zones/zone-type axis axis',
            # INITIALIZE
            '/solve/initialize/hyb-initialization',
