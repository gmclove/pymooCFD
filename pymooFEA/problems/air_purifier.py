...
from pymooFEA.core.feaCase import YALES2Case
...
# from pymooFEA.core.pymooBase import FEAGeneticProblem
#
# class Place_AP_Problem(FEAGeneticProblem):
#     def __init__(self, FEACase, n_APs=2, **kwargs):
#         super().__init__(FEACase, **kwargs)
#         self.n_APs = n_APs
#         self.
#         self.gaps =
