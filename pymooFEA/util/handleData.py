...
# from pymooFEA.util.sysTools import removeDir #, makeDir, emptyDir
# from pymooFEA.setupFEA import runCase
...
#     X = np.lodatxt(Xpath)
#     F = np.loadtxt(Fpath)
#     from pymooFEA.setupOpt import algorithm, problem
#
...
#
#     from pymooFEA.setupFEA import preProcGen, postProcGen
...
#
#     ###### RUN GENERATION ######
#     # from pymooFEA.setupFEA import runGen
#     # obj = runGen(genDir, X)
#     ###### RUN GENERATION ######
#     from pymooFEA.execSimsBatch import slurmExec #singleNodeExec
...
#     from pymooFEA.setupOpt import pop_size
...
#     from pymooFEA.setupOpt import problem
