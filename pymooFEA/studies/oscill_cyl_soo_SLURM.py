...
from pymooFEA.problems.oscill_cyl import OscillCylinder_SOO_SLURM as BaseCase
# from pymooFEA.core.pymooBase import FEATestProblem


def exec_test():
    study = MinimizeFEA(BaseCase) #, FEAGeneticProblem=FEATestProblem)
    run_dir = 'test_run'
...
# from pymoo.util.output import Output
...
#
# # from pymooFEA.util.yales2Tools import getLatestXMF
# # from pymooFEA.core.cfdCase import YALES2Case #FEACase
# from pymooFEA.studies.oscillCyl_x2 import OscillCylinder
#
#
...
# #    PROBLEM    #
# #################
# # from pymooFEA.core.pymooBase import GA_FEA
...
# #    Output    #
# #################
# # from pymooFEA.core.pymooBase import output
#
#
